#ifndef ETHERCAT_QUERY_INTERFACE_H
#define ETHERCAT_QUERY_INTERFACE_H
...
{
    /**
     * An interface for answering ethercat data queries
     *
     * @author Alex Mitrevski, Santosh Thoduka
     * @contact aleksandar.mitrevski@h-brs.de, santosh.thoduka@h-brs.de
     */
    class EthercatQueryInterface : public QueryInterfaceBase
    {
    public:
        /**
